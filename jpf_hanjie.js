...
function setupPuzzle() {
   // Math all of the data cells in the puzzle
   ...
   document.getElementById("peek").addEventListener("click",
      function() {
         ...
         setTimeout(
            function(){
               // Change pink cells to white and cells to gray
               for(var i = 0; i < puzzleCells.length; i++){
      ...
      }//end of anonumous function
      );
}//end of setupPuzzle

function setBackground(e) {
   var cursorType;
   // Set the cell background base on the keyboard key
   if(e.shiftKey) {
   ...
   //Create an event listenenr for every puzzle cell
   for (var i = 0; i < puzzleCells.length; i++) {
